...
if($t =  mysqli_fetch_assoc($total)){
    ...
    /*Incluindo paginação simples: Se houver próxima, exibirá o link Próxima. Se houver página anterior, exibirá Anterior. 
      Sendo assim, os dois links não são exibidos na primeira e nem na ultima página*/
